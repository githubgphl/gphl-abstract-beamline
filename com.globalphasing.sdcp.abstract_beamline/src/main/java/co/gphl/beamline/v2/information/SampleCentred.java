...
package co.gphl.beamline.v2.information;

import java.util.Collection;
import java.util.List;

import co.gphl.beamline.v2.Payload;
import co.gphl.beamline.v2.data_collection.Scan;
import co.gphl.beamline.v2.instrumentation.BcsDetectorSetting;
import co.gphl.beamline.v2.instrumentation.BeamstopSetting;
import co.gphl.beamline.v2.instrumentation.GoniostatTranslation;
import co.gphl.beamline.v2.ui.PhasingWavelength;
